//Chris Trentman, Anay Joshi, Amogh Silaparasetti, Jeff Edwards
// Homework 1
//This program takes the plain text from a series of formatted files and create a card catalog file and a statistics file.
#include <iostream>
#include <string>
#include <fstream>
#include "Node.h"
